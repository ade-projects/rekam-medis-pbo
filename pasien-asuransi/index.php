...
<head>
    <meta charset="UTF-8">
    <title>Kasir Asuransi Swasta - REMEDIS</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link active fw-bold" href="../pasien-asuransi/index.php">Asuransi</a></li>
...
<div class="container">
    ...
    <!-- Header & Search Box -->
    <div class="card shadow-sm p-4 mb-4 border-top border-warning border-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <h4 class="fw-bold text-warning m-0"><i class="bi bi-shield-check me-2"></i>Kasir Asuransi Swasta</h4>
            ...
            <table class="table table-hover align-middle mb-0">
                <thead class="table-warning">
                    <tr>
                        ...
                        <th>Nama Pasien</th>
                        <th>Tanggal Masuk</th>
                        <th>Provider</th><th>Limit Cover</th>
                        <th>Total Tagihan</th>
                    ...
                    <?php if (!empty($daftar_pasien)): ?>
                        <?php foreach ($daftar_pasien as $pasien): ?>
                            <tr>
                                ...
                                <td><span class='fw-semibold text-primary'><?= htmlspecialchars($pasien->getNamaProvider()) ?></span></td><td>Rp <?= number_format($pasien->getLimitCover(), 0, ',', '.') ?></td>
                                <td class="text-warning fw-bold">Rp <?= number_format($pasien->hitungTotalBiaya(), 0, ',', '.') ?></td>
                                <td class="text-center pe-3">
                                    <!-- Target blank untuk render isolasi -->
                                    <a href="?search=<?= urlencode($search) ?>&cetak=<?= $pasien->getIdPasien() ?>" target="_blank" class="btn btn-sm btn-warning fw-semibold shadow-sm">
